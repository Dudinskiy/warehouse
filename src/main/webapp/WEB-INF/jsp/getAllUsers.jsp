...
<div id="container" style="width:100%">
    ...
    <div id="content" style="background-color:#d3d3d3; height:100%; width:85%; float:left;">
        ...
        <table border="1" cellspacing="2" , cellpadding="10">
            ...
            <c:forEach var="usersFullDtoRes" items="${usersFullDtoResList}">
                <tr>
                    <td>${usersFullDtoRes.rowNumber}</td>
                    <td>${usersFullDtoRes.userId}</td>
                    <td>${usersFullDtoRes.firstName}</td>
                    <td>${usersFullDtoRes.lastName}</td>
                    <td>${usersFullDtoRes.login}</td>
                    <td>${usersFullDtoRes.role}</td>
                </tr>
            </c:forEach>
        </table>
