...
<div id="container" style="width:100%">
    ...
    <div id="content" style="background-color:#d3d3d3; height:100%; width:85%; float:left;">
        ...
        <form:form modelAttribute="producersDto" action="/warehouse/producers/create" method="post">
            <table>
                <tr>
                ...
                <tr>
                    <td>Введите страну:</td>
                    <td><form:select path="countryName">
                        <form:option value="">Страна не выбрана</form:option>
                        <c:forEach var="countriesDtoRes" items="${producersDto.countriesList}">
                            <form:option value="${countriesDtoRes.countryName}"></form:option>
                        </c:forEach>
                    </form:select></td>
                </tr>
                <tr>
