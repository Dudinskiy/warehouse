...
<div id="container" style="width:100%">
    ...
    <div id="content" style="background-color:#d3d3d3; height:100%; width:85%; float:left;">
        ...
        <table border="1" cellspacing="2" , cellpadding="10">
            ...
            <c:forEach var="countriesDtoRes" items="${countriesDtoResList}">
                <tr>
                    <td>${countriesDtoRes.rowNumber}</td>
                    <td>${countriesDtoRes.countryId}</td>
                    <td>${countriesDtoRes.countryName}</td>
                </tr>
            </c:forEach>
        </table>
