...
<div id="container" style="width:100%">
    ...
    <div id="content" style="background-color:#d3d3d3; height:100%; width:85%; float:left;">
        ...
        <table border="1" cellspacing="2" , cellpadding="10">
            ...
            <c:forEach var="ProductsFullDtoRes" items="${productsFullDtoResList}">
                <tr>
                    <td>${ProductsFullDtoRes.rowNumber}</td>
                    <td>${ProductsFullDtoRes.productId}</td>
                    <td>${ProductsFullDtoRes.productName}</td>
                    <td>${ProductsFullDtoRes.producerName}</td>
                    <td>${ProductsFullDtoRes.countryName}</td>
                    <td>${ProductsFullDtoRes.price}</td>
                    <td>${ProductsFullDtoRes.productAmount}</td>
                </tr>
            </c:forEach>
        </table>
