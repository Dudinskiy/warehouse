...
<div id="container" style="width:100%">
    ...
    <div id="content" style="background-color:#d3d3d3; height:100%; width:85%; float:left;">
        ...
        <table border="1" cellspacing="2" , cellpadding="10">
            ...
            <c:forEach var="ProducersFullDtoRes" items="${producersFullDtoResList}">
                <tr>
                    <td>${ProducersFullDtoRes.rowNumber}</td>
                    <td>${ProducersFullDtoRes.producerId}</td>
                    <td>${ProducersFullDtoRes.producerName}</td>
                    <td>${ProducersFullDtoRes.countryName}</td>
                </tr>
            </c:forEach>
        </table>
