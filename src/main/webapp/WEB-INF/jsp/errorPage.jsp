...
<div id="container" style="width:100%">
    ...
    <div class="menuBody" id="menu" style="background-color:#bebebe; height:100%; width:15%; float:left; ">
        <nav>
            <h2>Меню</h2>
    ...
    <div class="mainBody" id="content" style="background-color:#d3d3d3; height:100%; width:85%; float:left;">
        <p>Произошел сбой. Попробуйте снова</p>
    </div>
</div>
<footer>
