...
<div id="container" style="width:100%">
    ...
    <div id="content" style="background-color:#d3d3d3; height:100%; width:85%; float:left;">
        ...
        <h3>Отчетность по выбранному типу товарной операции за период</h3>
        <form:form modelAttribute="operationsDto" action="/warehouse/operations/report-by-period-type" method="post">
            <table>
                <tr>
                    ...
                    <td><form:select path="type">
                        ...
                        <c:forEach var="operationTypeDtoRes" items="${operationsDto.operationTypeList}">
                            <form:option value="${operationTypeDtoRes.type}">${operationTypeDtoRes.typeName}</form:option>
                        </c:forEach>
                    </form:select>
                    </td>
                </tr>
                <tr>
                    <td>Введите начальную дату:</td>
                    <td><input type="date" name="start1"></td>
                </tr>
                <tr>
                    <td>Введите конечную дату:</td>
                    <td><input type="date" name="end1"></td>
                </tr>
                <tr>
